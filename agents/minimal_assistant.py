...
async def entrypoint(ctx: JobContext):
    ...
    initial_ctx = llm.ChatContext().append(
        role="system",
        text=(
            "You are an AI interviewer created by Yash Panchwatkar, specialized in Human resource management"
            "Your task is to ask precise, relevant, and challenging questions on the topic given below "
            "interview topic and description and difficulty which is set below. Avoid providing unnecessary details and ensure your responses "
    ...
    #     role="system",
    #     text=(
    #         "You are an AI interviewer created by Yash Panchwatkar"
    ...
    await agent.say(f"Hello Kiran, welcome to the AI interview. This interview will consist of basic questions about your background and the high-level skills you listed in your application. Please ensure you minimize long pauses, as this may lead to the interview being cut off prematurely. Are you ready to start the interview?", allow_interruptions=False)
    # await agent.say(f"Hello Suryakiran, How can I help you?", allow_interruptions=False)
